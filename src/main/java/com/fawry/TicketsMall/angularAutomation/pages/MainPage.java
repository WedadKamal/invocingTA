        ...
        if(errType.equalsIgnoreCase(GeneralConstants.ERR_TYPE_PAGE))
        {
            ...
            for (int i = 0; i < matErrMsgs.size(); i++) {
                ...
                if (i != matErrMsgs.size() - 1)
                    allErrorMsgsString = allErrorMsgsString + GeneralConstants.STRING_DELIMITER;
            }
        }
            ...
            if (displayedText != null && !displayedText.trim()
                ...
                if (matSelect.getAttribute("aria-disabled")
                    ...
                    if (matSelect.getAttribute("aria-multiselectable")
                        ...
                        if (displayedText.contains(GeneralConstants.STRING_DELIMITER)) {
                            selectedOptions = displayedText.split(GeneralConstants.STRING_DELIMITER);
                ...
                if (matSelect.getAttribute("aria-disabled")
                    ...
                    if(selectOptionsIDSString != null) {
                        ...
                        if (matSelect.getAttribute("aria-multiselectable")
                                .equalsIgnoreCase(GeneralConstants.TRUE)) {
                            unselectAllMatSelectOptions(matSelect);
                            if (optionsIDs.contains(GeneralConstants.STRING_DELIMITER)) {
                                selectedOptions = optionsIDs.split(GeneralConstants.STRING_DELIMITER);
                                for (int i = 0; i < selectedOptions.length; i++) {
                                    ...
                                    if (i != selectedOptions.length - 1)
                                        selectedOptionsString += GeneralConstants.STRING_DELIMITER;
                                    option.click();
                                }
